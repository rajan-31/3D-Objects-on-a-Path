export class WebGLRenderer {
    constructor() {
        ...
        this.lightPosition = [4.0, 4.0, 4.0];
    ...
    renderForPicking(scene, shader) {
        ...
        for(let i = 0; i < scene.objects.length; i++) {
            ...
            shader.setUniformMatrix4fv("mWorld", object.modelTransformMatrix);
    ...
    setAmbientLight(r, g, b) {
        this.ambientLight = [r/255, g/255, b/255];
    }
    ...
    drawObject(object, shader, picked=false, highlightColor=null) {
        ...
        shader.bindArrayBuffer(shader.normalAttributesBuffer, object.normals);
        shader.fillAttributeData("a_normal", 3, 0, 0);

        this.setLightingUniforms(shader);
    ...
    setLightingUniforms(shader) {
        shader.setUniform3f("u_lightPosition", this.lightPosition);
        shader.setUniform3f("u_lightColor", this.lightColor);
        shader.setUniform3f("u_ambientLight", this.ambientLight);
        shader.setUniform1f("u_shininess", this.shininess);
    }
